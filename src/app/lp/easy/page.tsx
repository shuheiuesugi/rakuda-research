        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p className="footer-desc">テーマを入力するだけ。AIが出典つきのレポートを自動で作ります。</p>
            </div>
            <div>
              <div className="footer-column-title">プロダクト</div>
              <ul className="footer-links">
                <li><a href="../../#features" className="footer-link">できること</a></li>
                <li><a href="../../#pricing" className="footer-link">料金</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="footer-links">
                ...
                <li><a href="../../book-call" className="footer-link">お問い合わせ</a></li>
              </ul>
            </div>
            <div>
              <div className="footer-column-title">法的情報</div>
              <ul className="footer-links">
                <li><a href="../../terms" className="footer-link">利用規約</a></li>
                <li><a href="../../privacy" className="footer-link">プライバシー</a></li>
                <li><a href="../../tokushoho" className="footer-link">特商法</a></li>
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-legal-links">
              ...
              <a href="../../privacy" className="footer-legal-link">プライバシー</a>
