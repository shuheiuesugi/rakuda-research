    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: FONT, color: TEXT_PRIMARY }}>
      ...
      >
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "24px" }}>
          <a href="/demo/final/pricing" style={{ fontSize: "13px", color: TEXT_MUTED, textDecoration: "none" }}>料金</a>
          <a href="/demo/final/contact" style={{ fontSize: "13px", color: TEXT_PRIMARY, textDecoration: "none", fontWeight: 600 }}>お問い合わせ</a>
